...
public class ExamDao {
	...
	public Exam create(String result, Date examDate, Typology typology, Patient patient, Doctor doctor) {
		Exam exam = new Exam(result, examDate, typology, patient, doctor);
